...
export const en = {
  ...
  'events.cause.ownership_acquired': 'Taken over by node {node}',
  'events.cause.ownership_lost': 'Ownership expired and another node took over',
  'events.cause.connect_failed': 'Could not connect',
  'events.cause.logout_requested': 'Logout requested',
  'events.cause.stopped_by_command': 'Stopped by command',
  'events.cause.pairing_code_requested': 'Pairing code requested',
  'events.cause.qr_generated': 'QR generated',
  'events.cause.gave_up_reconnecting': 'Gave up reconnecting after {attempts} attempts',
  'events.cause.connected': 'Connected',
  'events.cause.paired': 'Paired',
  'events.cause.disconnect_401': 'Session ended on the phone',
  'events.cause.disconnect_403': 'Access denied by WhatsApp',
  'events.cause.disconnect_408': 'Timed out',
  'events.cause.disconnect_411': 'Multi-device mismatch',
  'events.cause.disconnect_428': 'Connection closed',
  'events.cause.disconnect_440': 'Session taken over elsewhere',
  'events.cause.disconnect_500': 'Corrupted session',
  'events.cause.disconnect_503': 'Service unavailable',
  'events.cause.disconnect_515': 'Restart required',
